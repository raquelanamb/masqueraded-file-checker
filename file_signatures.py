        ...
        for root, dirs, files in os.walk(folder_path):
            ...
            for file in files:
                ...
                if is_file_masqueraded(file_path):
                    # if so, print path (as long as it's not the Desktop
                    # Services Store file automatically generated by macOS
                    # Finder):
                    if file_path != "/Users/raquelana/Desktop/" \
                                    "CIS 442 project example/.DS_Store":
                        print(file_path)
                        print()
                        counter += 1
